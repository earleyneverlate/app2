	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='tvs' selected>Tvs</option><option value='sounds'>SoundSystems</option><option value='phones'>Phones</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
